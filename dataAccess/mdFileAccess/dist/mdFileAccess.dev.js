...
exports.getStackFileData = exports.getSettingsFileData = exports.getBlogFileJsonData = exports.readJsonFileDataBySlug = exports.readJsonFileData = exports.getBlogByFileNameData = exports.getBlogBySlugData = exports.getUserFileData = exports.getFileData = exports.getBlogsFilesData = void 0;
...
var getBlogByFileNameData = function getBlogByFileNameData(slug) {
  var blogData;
  return regeneratorRuntime.async(function getBlogByFileNameData$(_context5) {
    while (1) {
...
var readJsonFileData = function readJsonFileData() {
  var fileContents;
  return regeneratorRuntime.async(function readJsonFileData$(_context6) {
    while (1) {
...
var readJsonFileDataBySlug = function readJsonFileDataBySlug(slug) {
  ...
  return regeneratorRuntime.async(function readJsonFileDataBySlug$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 2:
          ...
          return _context7.abrupt("return", findJsonData);
...
var getBlogFileJsonData = function getBlogFileJsonData(_ref2) {
  ...
  return regeneratorRuntime.async(function getBlogFileJsonData$(_context8) {
    while (1) {
...
var getSettingsFileData = function getSettingsFileData() {
  var settingData;
  return regeneratorRuntime.async(function getSettingsFileData$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 2:
          settingData = _context9.sent;
          return _context9.abrupt("return", settingData);
...
var getStackFileData = function getStackFileData() {
  var stackData;
  return regeneratorRuntime.async(function getStackFileData$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
          _context10.next = 2;
          return regeneratorRuntime.awrap(getFileData('stack.md'));

        case 2:
          stackData = _context10.sent;
          return _context10.abrupt("return", stackData);
...
exports.getStackFileData = getStackFileData;