...
var createMetaDataBySortStackJson = function createMetaDataBySortStackJson() {
  var STACK_FOLDER_PATH, OUTPUT_FILE_PATH, blogMetaDataArray;
  return regeneratorRuntime.async(function createMetaDataBySortStackJson$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          STACK_FOLDER_PATH = path.join(MAIN_MD_FILE_PATH, 'stacks');
          OUTPUT_FILE_PATH = path.join(MAIN_MD_FILE_PATH, 'stacks.json');
          _context5.next = 4;
          return regeneratorRuntime.awrap(getBlogMetaData(STACK_FOLDER_PATH));
